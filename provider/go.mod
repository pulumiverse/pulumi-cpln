module github.com/pulumiverse/pulumi-cpln/provider

go 1.24.0

toolchain go1.24.4

replace github.com/controlplane-com/terraform-provider-cpln/shim => ./shim

require (
	github.com/controlplane-com/terraform-provider-cpln/shim v0.0.0
...
require (
	...
	github.com/controlplane-com/terraform-provider-cpln v1.2.12 // indirect
