...
export function getSecret(args: GetSecretArgs, opts?: pulumi.InvokeOptions): Promise<GetSecretResult> {
    ...
    return pulumi.runtime.invoke("cpln:index/getSecret:getSecret", {
        "aws": args.aws,
        "azureConnectors": args.azureConnectors,
        "ecrs": args.ecrs,
        "keypairs": args.keypairs,
        "name": args.name,
        "natsAccounts": args.natsAccounts,
        "opaques": args.opaques,
        "tls": args.tls,
        "userpasses": args.userpasses,
    }, opts);
}
...
export interface GetSecretOutputArgs {
    aws?: pulumi.Input<pulumi.Input<inputs.GetSecretAwArgs>[]>;
    azureConnectors?: pulumi.Input<pulumi.Input<inputs.GetSecretAzureConnectorArgs>[]>;
    ecrs?: pulumi.Input<pulumi.Input<inputs.GetSecretEcrArgs>[]>;
    keypairs?: pulumi.Input<pulumi.Input<inputs.GetSecretKeypairArgs>[]>;
    name: pulumi.Input<string>;
    natsAccounts?: pulumi.Input<pulumi.Input<inputs.GetSecretNatsAccountArgs>[]>;
    opaques?: pulumi.Input<pulumi.Input<inputs.GetSecretOpaqueArgs>[]>;
    tls?: pulumi.Input<pulumi.Input<inputs.GetSecretTlArgs>[]>;
    userpasses?: pulumi.Input<pulumi.Input<inputs.GetSecretUserpassArgs>[]>;
}
