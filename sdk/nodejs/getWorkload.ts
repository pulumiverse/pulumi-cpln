...
export function getWorkload(args: GetWorkloadArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkloadResult> {
    ...
    return pulumi.runtime.invoke("cpln:index/getWorkload:getWorkload", {
        "containers": args.containers,
        "firewallSpecs": args.firewallSpecs,
        "gvc": args.gvc,
        "jobs": args.jobs,
        "loadBalancers": args.loadBalancers,
        "localOptions": args.localOptions,
        "name": args.name,
        "options": args.options,
        "requestRetryPolicies": args.requestRetryPolicies,
        "rolloutOptions": args.rolloutOptions,
        "securityOptions": args.securityOptions,
...
export interface GetWorkloadArgs {
    containers?: inputs.GetWorkloadContainer[];
    firewallSpecs?: inputs.GetWorkloadFirewallSpec[];
    gvc: string;
    jobs?: inputs.GetWorkloadJob[];
    loadBalancers?: inputs.GetWorkloadLoadBalancer[];
    localOptions?: inputs.GetWorkloadLocalOption[];
    name: string;
    options?: inputs.GetWorkloadOption[];
    requestRetryPolicies?: inputs.GetWorkloadRequestRetryPolicy[];
    rolloutOptions?: inputs.GetWorkloadRolloutOption[];
    securityOptions?: inputs.GetWorkloadSecurityOption[];
    sidecars?: inputs.GetWorkloadSidecar[];
...
export interface GetWorkloadResult {
    readonly containers?: outputs.GetWorkloadContainer[];
    readonly cplnId: string;
    readonly description: string;
    readonly extras: string;
    readonly firewallSpecs?: outputs.GetWorkloadFirewallSpec[];
    readonly gvc: string;
    readonly health: outputs.GetWorkloadHealth;
    readonly id: string;
    readonly identityLink: string;
    readonly jobs?: outputs.GetWorkloadJob[];
    readonly loadBalancers?: outputs.GetWorkloadLoadBalancer[];
    readonly localOptions?: outputs.GetWorkloadLocalOption[];
    readonly name: string;
    readonly options?: outputs.GetWorkloadOption[];
    readonly requestRetryPolicies?: outputs.GetWorkloadRequestRetryPolicy[];
    readonly rolloutOptions?: outputs.GetWorkloadRolloutOption[];
    readonly securityOptions?: outputs.GetWorkloadSecurityOption[];
    readonly selfLink: string;
    readonly sidecars?: outputs.GetWorkloadSidecar[];
    readonly statuses: outputs.GetWorkloadStatus[];
    readonly supportDynamicTags: boolean;
    readonly tags: {[key: string]: string};
    readonly type: string;
    readonly vm: outputs.GetWorkloadVm;
}
/**
 * Use this data source to access information about an existing [Workload](https://docs.controlplane.com/reference/workload) within Control Plane.
 *
...
export function getWorkloadOutput(args: GetWorkloadOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkloadResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cpln:index/getWorkload:getWorkload", {
        "containers": args.containers,
        "firewallSpecs": args.firewallSpecs,
        "gvc": args.gvc,
        "jobs": args.jobs,
...
export interface GetWorkloadOutputArgs {
    containers?: pulumi.Input<pulumi.Input<inputs.GetWorkloadContainerArgs>[]>;
    firewallSpecs?: pulumi.Input<pulumi.Input<inputs.GetWorkloadFirewallSpecArgs>[]>;
    gvc: pulumi.Input<string>;
    jobs?: pulumi.Input<pulumi.Input<inputs.GetWorkloadJobArgs>[]>;
    loadBalancers?: pulumi.Input<pulumi.Input<inputs.GetWorkloadLoadBalancerArgs>[]>;
    localOptions?: pulumi.Input<pulumi.Input<inputs.GetWorkloadLocalOptionArgs>[]>;
    name: pulumi.Input<string>;
    options?: pulumi.Input<pulumi.Input<inputs.GetWorkloadOptionArgs>[]>;
    requestRetryPolicies?: pulumi.Input<pulumi.Input<inputs.GetWorkloadRequestRetryPolicyArgs>[]>;
    rolloutOptions?: pulumi.Input<pulumi.Input<inputs.GetWorkloadRolloutOptionArgs>[]>;
    securityOptions?: pulumi.Input<pulumi.Input<inputs.GetWorkloadSecurityOptionArgs>[]>;
    sidecars?: pulumi.Input<pulumi.Input<inputs.GetWorkloadSidecarArgs>[]>;
