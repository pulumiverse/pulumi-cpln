...
type GetImagesArgs struct {
	Query *GetImagesQuery `pulumi:"query"`
}
...
type GetImagesOutputArgs struct {
	Query GetImagesQueryPtrInput `pulumi:"query"`
}
...
func (o GetImagesResultOutput) Query() GetImagesQueryPtrOutput {
	return o.ApplyT(func(v GetImagesResult) *GetImagesQuery { return v.Query }).(GetImagesQueryPtrOutput)
}
