...
// Description of the Audit Context.
func (o AuditContextOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *AuditContext) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
