...
type Org struct {
	...
	Observability OrgObservabilityPtrOutput `pulumi:"observability"`
...
// Description of the Organization.
func (o OrgOutput) Description() pulumi.StringOutput {
...
// The retention period (in days) for logs, metrics, and traces. Charges apply for storage beyond the 30 day default.
func (o OrgOutput) Observability() OrgObservabilityPtrOutput {
	return o.ApplyT(func(v *Org) OrgObservabilityPtrOutput { return v.Observability }).(OrgObservabilityPtrOutput)
}
