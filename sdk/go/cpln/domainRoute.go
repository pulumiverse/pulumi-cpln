...
type DomainRoute struct {
	...
	Replica pulumi.IntPtrOutput `pulumi:"replica"`
...
// The port the route corresponds to. Default: 443
func (o DomainRouteOutput) DomainPort() pulumi.IntOutput {
	return o.ApplyT(func(v *DomainRoute) pulumi.IntOutput { return v.DomainPort }).(pulumi.IntOutput)
}
...
// The replica number of a stateful workload to route to. If not provided, traffic will be routed to all replicas.
func (o DomainRouteOutput) Replica() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *DomainRoute) pulumi.IntPtrOutput { return v.Replica }).(pulumi.IntPtrOutput)
}
