...
namespace Pulumiverse.Cpln
{
    ...
    {
        [Input("query")]
        public Inputs.GetImagesQueryArgs? Query { get; set; }
    ...
    {
        [Input("query")]
        public Input<Inputs.GetImagesQueryInputArgs>? Query { get; set; }
    ...
    public sealed class GetImagesResult
    {
        ...
        public readonly Outputs.GetImagesQueryResult? Query;
        ...
        private GetImagesResult(
            ...
            Outputs.GetImagesQueryResult? query)
        {
            Id = id;
            Images = images;
            Query = query;
