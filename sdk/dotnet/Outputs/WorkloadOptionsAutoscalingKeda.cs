...
namespace Pulumiverse.Cpln.Outputs
{
    ...
    [OutputType]
    public sealed class WorkloadOptionsAutoscalingKeda
    {
        /// <summary>
        /// Advanced configuration options for KEDA.
        /// </summary>
        public readonly Outputs.WorkloadOptionsAutoscalingKedaAdvanced? Advanced;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.WorkloadOptionsAutoscalingKedaFallback? Fallback;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.WorkloadOptionsAutoscalingKedaTrigger> Triggers;

        [OutputConstructor]
        private WorkloadOptionsAutoscalingKeda(
            Outputs.WorkloadOptionsAutoscalingKedaAdvanced? advanced,

            int? cooldownPeriod,

            Outputs.WorkloadOptionsAutoscalingKedaFallback? fallback,

            int? initialCooldownPeriod,

            int? pollingInterval,

            ImmutableArray<Outputs.WorkloadOptionsAutoscalingKedaTrigger> triggers)
        {
            Advanced = advanced;
