...
namespace Pulumiverse.Cpln.Inputs
{
    ...
    public sealed class GetWorkloadLocalOptionAutoscalingKedaTriggerArgs : global::Pulumi.InvokeArgs
    {
        [Input("authenticationReves")]
        private List<Inputs.GetWorkloadLocalOptionAutoscalingKedaTriggerAuthenticationRefArgs>? _authenticationReves;

        /// <summary>
        /// Reference to a KEDA authentication object for secure access to external systems.
        /// </summary>
        public List<Inputs.GetWorkloadLocalOptionAutoscalingKedaTriggerAuthenticationRefArgs> AuthenticationReves
        {
            get => _authenticationReves ?? (_authenticationReves = new List<Inputs.GetWorkloadLocalOptionAutoscalingKedaTriggerAuthenticationRefArgs>());
        ...
        public GetWorkloadLocalOptionAutoscalingKedaTriggerArgs()
        {
        }
        public static new GetWorkloadLocalOptionAutoscalingKedaTriggerArgs Empty => new GetWorkloadLocalOptionAutoscalingKedaTriggerArgs();
    }
}
