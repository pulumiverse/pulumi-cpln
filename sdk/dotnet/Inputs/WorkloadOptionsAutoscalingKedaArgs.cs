...
namespace Pulumiverse.Cpln.Inputs
{
    ...
    public sealed class WorkloadOptionsAutoscalingKedaArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Advanced configuration options for KEDA.
        /// </summary>
        [Input("advanced")]
        public Input<Inputs.WorkloadOptionsAutoscalingKedaAdvancedArgs>? Advanced { get; set; }
        ...
        /// </summary>
        [Input("fallback")]
        public Input<Inputs.WorkloadOptionsAutoscalingKedaFallbackArgs>? Fallback { get; set; }
        ...
        [Input("triggers")]
        private InputList<Inputs.WorkloadOptionsAutoscalingKedaTriggerArgs>? _triggers;
        ...
        /// </summary>
        public InputList<Inputs.WorkloadOptionsAutoscalingKedaTriggerArgs> Triggers
        {
            get => _triggers ?? (_triggers = new InputList<Inputs.WorkloadOptionsAutoscalingKedaTriggerArgs>());
            set => _triggers = value;
        }

        public WorkloadOptionsAutoscalingKedaArgs()
        {
        }
        public static new WorkloadOptionsAutoscalingKedaArgs Empty => new WorkloadOptionsAutoscalingKedaArgs();
    }
}
