...
namespace Pulumiverse.Cpln.Inputs
{
    ...
    public sealed class GetWorkloadLocalOptionAutoscalingArgs : global::Pulumi.InvokeArgs
    {
        [Input("kedas")]
        private List<Inputs.GetWorkloadLocalOptionAutoscalingKedaArgs>? _kedas;

        /// <summary>
        /// KEDA (Kubernetes-based Event Driven Autoscaling) allows for advanced autoscaling based on external metrics and triggers.
        /// </summary>
        public List<Inputs.GetWorkloadLocalOptionAutoscalingKedaArgs> Kedas
        {
            get => _kedas ?? (_kedas = new List<Inputs.GetWorkloadLocalOptionAutoscalingKedaArgs>());
            set => _kedas = value;
        }
        ...
        [Input("multis")]
        private List<Inputs.GetWorkloadLocalOptionAutoscalingMultiArgs>? _multis;
        public List<Inputs.GetWorkloadLocalOptionAutoscalingMultiArgs> Multis
        {
            get => _multis ?? (_multis = new List<Inputs.GetWorkloadLocalOptionAutoscalingMultiArgs>());
            set => _multis = value;
        }
        ...
        public GetWorkloadLocalOptionAutoscalingArgs()
        {
        }
        public static new GetWorkloadLocalOptionAutoscalingArgs Empty => new GetWorkloadLocalOptionAutoscalingArgs();
    }
}
