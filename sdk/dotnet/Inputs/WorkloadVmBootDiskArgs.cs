...
namespace Pulumiverse.Cpln.Inputs
{
    ...
    public sealed class WorkloadVmBootDiskArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("persist")]
        public Input<Inputs.WorkloadVmBootDiskPersistArgs>? Persist { get; set; }

        /// <summary>
        /// Boot disk image source. Exactly one of `Oci` or `Http` must be specified.
        /// </summary>
        [Input("source")]
        public Input<Inputs.WorkloadVmBootDiskSourceArgs>? Source { get; set; }

        public WorkloadVmBootDiskArgs()
        {
        }
        public static new WorkloadVmBootDiskArgs Empty => new WorkloadVmBootDiskArgs();
    }
}
