...
namespace Pulumiverse.Cpln.Inputs
{
    ...
    public sealed class GetWorkloadOptionAutoscalingInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("kedas")]
        private InputList<Inputs.GetWorkloadOptionAutoscalingKedaInputArgs>? _kedas;

        /// <summary>
        /// KEDA (Kubernetes-based Event Driven Autoscaling) allows for advanced autoscaling based on external metrics and triggers.
        /// </summary>
        public InputList<Inputs.GetWorkloadOptionAutoscalingKedaInputArgs> Kedas
        {
            get => _kedas ?? (_kedas = new InputList<Inputs.GetWorkloadOptionAutoscalingKedaInputArgs>());
            set => _kedas = value;
        }
        ...
        [Input("multis")]
        private InputList<Inputs.GetWorkloadOptionAutoscalingMultiInputArgs>? _multis;
        public InputList<Inputs.GetWorkloadOptionAutoscalingMultiInputArgs> Multis
        {
            get => _multis ?? (_multis = new InputList<Inputs.GetWorkloadOptionAutoscalingMultiInputArgs>());
            set => _multis = value;
        }
        ...
        public GetWorkloadOptionAutoscalingInputArgs()
        {
        }
        public static new GetWorkloadOptionAutoscalingInputArgs Empty => new GetWorkloadOptionAutoscalingInputArgs();
    }
}
