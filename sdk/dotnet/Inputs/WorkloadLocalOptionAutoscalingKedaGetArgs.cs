...
namespace Pulumiverse.Cpln.Inputs
{
    ...
    public sealed class WorkloadLocalOptionAutoscalingKedaGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Advanced configuration options for KEDA.
        /// </summary>
        [Input("advanced")]
        public Input<Inputs.WorkloadLocalOptionAutoscalingKedaAdvancedGetArgs>? Advanced { get; set; }
        ...
        [Input("triggers")]
        private InputList<Inputs.WorkloadLocalOptionAutoscalingKedaTriggerGetArgs>? _triggers;
        ...
        /// </summary>
        public InputList<Inputs.WorkloadLocalOptionAutoscalingKedaTriggerGetArgs> Triggers
        {
            get => _triggers ?? (_triggers = new InputList<Inputs.WorkloadLocalOptionAutoscalingKedaTriggerGetArgs>());
            set => _triggers = value;
        }

        public WorkloadLocalOptionAutoscalingKedaGetArgs()
        {
        }
        public static new WorkloadLocalOptionAutoscalingKedaGetArgs Empty => new WorkloadLocalOptionAutoscalingKedaGetArgs();
    }
}
