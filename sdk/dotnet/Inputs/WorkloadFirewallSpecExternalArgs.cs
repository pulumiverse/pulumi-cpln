...
namespace Pulumiverse.Cpln.Inputs
{
    ...
    public sealed class WorkloadFirewallSpecExternalArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Firewall options for HTTP workloads.
        /// </summary>
        [Input("http")]
        public Input<Inputs.WorkloadFirewallSpecExternalHttpArgs>? Http { get; set; }
        ...
        private InputList<Inputs.WorkloadFirewallSpecExternalOutboundAllowPortArgs>? _outboundAllowPorts;
        ...
        /// </summary>
        public InputList<Inputs.WorkloadFirewallSpecExternalOutboundAllowPortArgs> OutboundAllowPorts
        {
            get => _outboundAllowPorts ?? (_outboundAllowPorts = new InputList<Inputs.WorkloadFirewallSpecExternalOutboundAllowPortArgs>());
            set => _outboundAllowPorts = value;
        }

        [Input("outboundBlockedCidrs")]
        ...
        public WorkloadFirewallSpecExternalArgs()
        {
        }
        public static new WorkloadFirewallSpecExternalArgs Empty => new WorkloadFirewallSpecExternalArgs();
    }
}
