...
namespace Pulumiverse.Cpln
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Cpln.version.txt");
    ...
    internal sealed class CplnResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CplnResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
